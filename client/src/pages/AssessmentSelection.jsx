...
const AssessmentSelection = () => {
  ...
  const handleStartPractice = () => {
    ...
    } else if (selectedPracticeType === "adaptive") {
      navigate("/adaptive/assessment");
    } else if (selectedPracticeType === "topicwise") {
      navigate("/SelectionBased"); // ✅ New route for Topic-wise Assessment
    }
  };
          ...
          <motion.div variants={itemVariants} className="mb-8">
            ...
            <div className="space-y-4">
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.99 }}
                className={`relative p-6 border-2 rounded-2xl cursor-pointer transition-all duration-300 ${
                  selectedPracticeType === "topicwise"
                    ? "border-blue-400 bg-blue-50 shadow-md"
                    : "border-gray-200 bg-white hover:border-blue-200 hover:bg-blue-25"
                }`}
                onClick={() => setSelectedPracticeType("topicwise")}
              >
                <div className="flex items-center">
                  <div className="flex-1">
                    <div className="flex items-center mb-2">
                      <div className="w-8 h-8 bg-gradient-to-br from-green-400 to-green-500 rounded-xl flex items-center justify-center mr-3">
                        <span className="text-white text-sm font-bold">📘</span>
                      </div>
                      <h4 className="text-lg font-bold text-gray-900">
                        Topic-wise Assessment
